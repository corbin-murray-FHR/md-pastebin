...
- 002-fix-anchor-links: Added [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION]
- 001-markdown-pastebin: Added TypeScript 5.x (React 18+, Vite 5+) + React, Vite, lz-string, shadcn/ui, tailwindcss v4.1, motion
